...
nodeDataArray = [
    ...
    { "key": 8, "loc": "400 250", "text": "ดับเบิ้ลชีส\nขอบไส้กรอก", "category": "Start" },
  
    { "key": 9, "loc": "600 -200", "text": "ฮาวายเอียน\nขอบชีส\nเพิ่มชีส", "category": "Start" },
    { "key": 10, "loc": "600 -100", "text": "ซีฟู้ด\nขอบชีส\nเพิ่มชีส", "category": "Start" },
  
    { "key": 11, "loc": "600 100", "text": "ฮาวายเอียน\nขอบไส้กรอก\nเพิ่มชีส", "category": "Start" },
    { "key": 12, "loc": "600 200", "text": "ซีฟู้ด\nขอบไส้กรอก\nเพิ่มชีส", "category": "Start" },
  ...
  linkDataArray = [
    { "from": 0, "to": 0, "points": [5, 60, -30, 60, -30, 100, 10, 100, 10, 65], "segmentIndex": 2, "segmentFraction": 0.5, "text": "ฮาวายเอียน,\nซีฟู้ด,ดับเบิ้ลชีส,\nเพิ่มชีส,\nReset,Confirm" },
    { "from": 0, "to": 1, "text": "ขอบชีส", "segmentIndex": 2, "segmentFraction": 0.4 },
    { "from": 0, "to": 2, "text": "ขอบไส้กรอก", "segmentIndex": 2, "segmentFraction": 0.4 },
  
    { "from": 1, "to": 0, "points": [240, -100, 240, -150,60,-150,60,10], "text": "ขอบชีส", "segmentIndex": 1, "segmentFraction": 1 },
    ...
    { "from": 2, "to": 0, "points": [240, 100, 240, 230,60,230,60,70], "text": "ขอบไส้กรอก", "segmentIndex": 1, "segmentFraction": 1 },
    ...
    //layer 2 up
    { "from": 3, "to": 1, "text": "ฮาวายเอียน", "points": [400, -200, 320, -200, 320, -70, 280, -70], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 3, "to": 3, "points": [406, -230, 370, -230, 370, -250, 440, -250], "segmentIndex": 1, "segmentFraction": 0.5, "text": "ขอบชีส" },
    { "from": 3, "to": 4, "text": "ซีฟู้ด", "points": [410, -185, 410, -135], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 3, "to": 5, "text": "ดับเบิ้ลชีส", "points": [480, -220, 550, -220, 550, -10, 480, -10], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 3, "to": 6, "text": "ขอบไส้กรอก", "points": [465, -240, 570, -240, 570, 60, 465, 60], "segmentIndex": 0, "segmentFraction": 0.45 },
    { "from": 3, "to": 9, "text": "เพิ่มชีส", "points": [475, -190, 608, -180,], "segmentIndex": 0, "segmentFraction": 0.15 },
  
    { "from": 4, "to": 1, "text": "ซีฟู้ด", "points": [405, -95, 320, -95, 320, -70, 280, -70], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 4, "to": 3, "text": "ฮาวายเอียน", "points": [470, -135, 470, -185], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 4, "to": 4, "points": [406, -130, 370, -130, 370, -150, 440, -150], "segmentIndex": 1, "segmentFraction": 1, "text": "ขอบชีส" },
    { "from": 4, "to": 5, "text": "ดับเบิ้ลชีส", "points": [410, -85, 410, -35], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 4, "to": 7, "text": "ขอบไส้กรอก", "points": [475, -120, 570, -120, 570, 180, 475, 180], "segmentIndex": 0, "segmentFraction": 0.25 },
    { "from": 4, "to": 10, "text": "เพิ่มชีส", "points": [475, -90, 608, -80,], "segmentIndex": 0, "segmentFraction": 0.15 },
  
    { "from": 5, "to": 1, "text": "ดับเบิ้ลชีส", "points": [400, 0, 320, 0, 320, -70, 280, -70], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 5, "to": 3, "text": "ฮาวายเอียน", "points": [480, -20, 540, -20, 540, -210, 480, -210], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 5, "to": 4, "text": "ซีฟู้ด", "points": [470, -35, 470, -85], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 5, "to": 5, "points": [406, -30, 370, -30, 370, -50, 440, -50], "segmentIndex": 1, "segmentFraction": 1, "text": "ขอบชีส,\nปลาร้า" },
    { "from": 5, "to": 8, "text": "ขอบไส้กรอก", "points": [480, 0, 570, 0, 570, 300, 480, 300], "segmentIndex": 0, "segmentFraction": 0.25 },
  
    // //layer 2 down
    { "from": 6, "to": 2, "text": "ฮาวายเอียน", "points": [400, 100, 320, 100, 320, 130, 280, 130], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 6, "to": 3, "text": "ขอบชีส", "points": [475, 70, 570, 70, 570, -230, 475, -230,], "segmentIndex": 0, "segmentFraction": 0.45 },
    { "from": 6, "to": 6, "points": [406, 70, 370, 70, 370, 50, 440, 50], "segmentIndex": 1, "segmentFraction": 0.5, "text": "ขอบไส้กรอก" },
    { "from": 6, "to": 7, "text": "ซีฟู้ด", "points": [410, 115, 410, 165], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 6, "to": 8, "text": "ดับเบิ้ลชีส", "points": [480, 80, 550, 80, 550, 290, 480, 290], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 6, "to": 11, "text": "เพิ่มชีส", "points": [477, 110, 615, 120,], "segmentIndex": 0, "segmentFraction": 0.2 },
  
    { "from": 7, "to": 2, "text": "ซีฟู้ด", "points": [400, 200, 320, 200, 320, 130, 280, 130], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 7, "to": 4, "text": "ขอบชีส", "points": [480, 190, 570, 190, 570, -110, 480, -110,], "segmentIndex": 0, "segmentFraction": 0.25 },
    { "from": 7, "to": 6, "text": "ฮาวายเอียน", "points": [470, 165, 470, 115], "segmentIndex": 0, "segmentFraction": 0.5 },
    { "from": 7, "to": 7, "points": [406, 170, 370, 170, 370, 150, 440, 150], "segmentIndex": 1, "segmentFraction": 1, "text": "ขอบไส้กรอก" },
    { "from": 7, "to": 8, "text": "ดับเบิ้ลชีส", "points": [410, 215, 410, 265], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 7, "to": 12, "text": "เพิ่มชีส", "points": [477, 210, 615, 220,], "segmentIndex": 0, "segmentFraction": 0.2 },
  
    { "from": 8, "to": 2, "text": "ดับเบิ้ลชีส", "points": [400, 300, 320, 300, 320, 130, 280, 130], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 8, "to": 5, "text": "ขอบชีส", "points": [474, 310, 570, 310, 570, 10, 474, 10,], "segmentIndex": 0, "segmentFraction": 0.25 },
    { "from": 8, "to": 6, "text": "ฮาวายเอียน", "points": [480, 280, 540, 280, 540, 90, 480, 90], "segmentIndex": 0, "segmentFraction": 0.3 },
    { "from": 8, "to": 7, "text": "ซีฟู้ด", "points": [470, 265, 470, 215], "segmentIndex": 0, "segmentFraction": 0.5 },
    { "from": 8, "to": 8, "points": [406, 270, 370, 270, 370, 250, 440, 250], "segmentIndex": 1, "segmentFraction": 1, "text": "ขอบไส้กรอก,\nปลาร้า" },
  
    //layer 3 
    { "from": 9, "to": 3, "text": "เพิ่มชีส", "points": [615, -190, 475, -200], "segmentIndex": 0, "segmentFraction": 0.2 },
    { "from": 9, "to": 9, "text": "ขอบชีส,\nฮาวายเอียน,\nดับเบิ้ลชีส", "points": [660, -195, 660, -220, 690, -220, 690, -190, 665, -190], "segmentIndex": 1, "segmentFraction": 0.5 },
    { "from": 9, "to": 10, "text": "ซีฟู้ด", "points": [610, -135, 610, -85], "segmentIndex": 0, "segmentFraction": 0.5 },
    { "from": 9, "to": 11, "text": "ขอบไส้กรอก", "points": [679, -170, 770, -160, 770, 120, 679, 130], "segmentIndex": 0, "segmentFraction": 0.7 },
  
    { "from": 10, "to": 4, "text": "เพิ่มชีส", "points": [615, -90, 475, -100], "segmentIndex": 0, "segmentFraction": 0.2 },
    { "from": 10, "to": 9, "text": "ฮาวายเอียน", "points": [670, -85, 670, -135], "segmentIndex": 0, "segmentFraction": 0.5 },
    { "from": 10, "to": 10, "text": "ขอบชีส,ซีฟู้ด,\nดับเบิ้ลชีส", "points": [660, -25, 660, 0, 690, 0, 690, -30, 666, -30,], "segmentIndex": 1, "segmentFraction": 0.5 },
    { "from": 10, "to": 12, "text": "ขอบไส้กรอก", "points": [677, -50, 750, -30, 750, 250, 675, 260], "segmentIndex": 0, "segmentFraction": 0.5 },
  
    { "from": 11, "to": 6, "text": "เพิ่มชีส", "points": [615, 110, 477, 100], "segmentIndex": 0, "segmentFraction": 0.2 },
    { "from": 11, "to": 9, "text": "ขอบชีส", "points": [680, 140, 760, 130, 760, -150, 680, -160], "segmentIndex": 0, "segmentFraction": 0.4 },
    { "from": 11, "to": 11, "text": "ขอบไส้กรอก,ฮาวายเอียน,\nดับเบิ้ลชีส", "points": [660, 105, 660, 80, 690, 80, 690, 110, 665, 110], "segmentIndex": 1, "segmentFraction": 0.5 },
    { "from": 11, "to": 12, "text": "ซีฟู้ด", "points": [610, 165, 610, 215], "segmentIndex": 0, "segmentFraction": 0.5 },
  
    { "from": 12, "to": 7, "text": "เพิ่มชีส", "points": [615, 210, 477, 200], "segmentIndex": 0, "segmentFraction": 0.2 },
